        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="{{ url('detail-branch') }}" class="btn card card-statistic-1">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="{{ url('detail-faculty') }}" class="btn card card-statistic-1">
                        <div class="card-icon bg-danger">
                            <i class="far fa-newspaper"></i>
                        </div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Fakultas Terdaftar</h4>
                            </div>
                            <div class="card-body">
                                {{ $faculties->count() }}
                            </div>
