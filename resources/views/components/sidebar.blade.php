    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'forms' ? 'active' : '' }}">
                <a href="#"
                    class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Form Admin</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('form-add-faculty') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('form-add-faculty') }}">Form add Faculty</a>
                    </li>
                    <li class="{{ Request::is('form-add-subject') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('form-add-subject') }}">Form add Subject</a>
                    </li>
            ...
            <li class="menu-header">Details Control</li>
            <li class="nav-item dropdown {{ $type_menu === 'details' ? 'active': '' }}">
                <a href="#"
                    class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Details Control</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('detail-branch') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-branch') }}">detail Branch</a>
                    </li>
                    <li class="{{ Request::is('detail-faculty') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-faculty') }}">detail Faculty</a>
                    </li>
                    <li class="{{ Request::is('detail-branch-faculty') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-branch-faculty') }}">detail Branch Faculty</a>
                    </li>
                    <li class="{{ Request::is('detail-building') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-building') }}">detail Building</a>
                    </li>

                    <li class="{{ Request::is('detail-facility') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-facility') }}">detail Facility</a>
                    </li>
                    <li class="{{ Request::is('detail-classroom') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-classroom') }}">detail Classroom</a>
                    </li>

                    <li class="{{ Request::is('detail-department') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-department') }}">detail Department</a>
                    </li>
                    <li class="{{ Request::is('detail-subject') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('detail-subject') }}">detail Subject</a>
                    </li>
                </ul>
            ...
            <li class="nav-item dropdown {{ $type_menu === 'layout' ? 'active' : '' }}">
                <a href="#"
                    ...
                    data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Form Admin</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('layout-default-layout') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('layout-default-layout') }}">Form Add Subject</a>
                    </li>
                    <li class="{{ Request::is('transparent-sidebar') ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ url('transparent-sidebar') }}">Form Add Branch</a>
                    </li>
                </ul>
            </li>
