...
$("#modal-8").fireModal({
    title: "create-branch",
    body: $("#modal-create-branch"),
    footerClass: "bg-whitesmoke",
    autoFocus: false,
});

$("#modal-9").fireModal({
    title: "create-branch-faculty",
    body: $("#modal-create-branch-faculty"),
    footerClass: "bg-whitesmoke",
    autoFocus: false,
});
...
$("#modal-14").fireModal({
    ...
    body: $("#modal-create-department"),
    footerClass: "bg-whitesmoke",
    autoFocus: false,
});

$("#modal-15").fireModal({
    title: "create-profesor-has-subject",
    body: $("#modal-create-profesor-has-subject"),
    footerClass: "bg-whitesmoke",
    autoFocus: false,
});
